<template>
    <v-card>
        ...
        <v-card-actions>
            ...
            <v-row>
                <v-col cols="6">
                    <v-card-title style="font-size: larger; text-align: center"
        ...
        <v-tabs v-model="tab" fixed-tabs>
            <v-tab :value="1" text="Productos"> </v-tab>
            <v-tab :value="2" text="Cliente"> </v-tab>
            <v-tab :value="3" text="Resumen"> </v-tab>
            <v-tab :value="4" text=" Pago"> </v-tab>
        </v-tabs>
        <v-card-text>
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td>
                                    {{
                                        FormatCurrency(
                                            producto.producto.precio_de_venta
                                        )
                                    }}
                                </td>
                                <td v-if="venta.cliente_id">
                                    {{
                                        formatCurrency(
                                            producto.total / producto.peso
                                        )
                                    }}
                                </td>
                        ...
                        <v-col cols="12">
                            <div style="text-align: center; width: 400px">
                                <strong style="font-size: x-large"
                                    >Total:
                                    {{ FormatCurrency(venta.total) }}</strong
                                ><br />
                                <strong style="font-size: x-large"
                                    >Resta:
                                    {{ FormatCurrency(venta.pago.pendiente) }}
                                </strong>
                                <br />
                                <strong
                                    style="font-size: x-large"
                                    v-if="pago.cambio > 0"
                                    >Cambio: {{ FormatCurrency(pago.cambio) }}
                                </strong>
                            </div>
                        </v-col>
